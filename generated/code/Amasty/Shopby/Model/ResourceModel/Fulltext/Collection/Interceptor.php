...
class Interceptor extends \Amasty\Shopby\Model\ResourceModel\Fulltext\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setRequestData');
        if (!$pluginInfo) {
            return parent::setRequestData($builder);
        } else {
            return $this->___callPlugins('setRequestData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMemRequestBuilder');
        if (!$pluginInfo) {
            return parent::getMemRequestBuilder();
        } else {
            return $this->___callPlugins('getMemRequestBuilder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIndexCategoriesFilter');
        if (!$pluginInfo) {
            return parent::addIndexCategoriesFilter($categoriesFilter);
        } else {
            return $this->___callPlugins('addIndexCategoriesFilter', func_get_args(), $pluginInfo);
        }
    }
