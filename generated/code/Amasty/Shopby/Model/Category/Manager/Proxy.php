<?php
namespace Amasty\Shopby\Model\Category\Manager;

/**
 * Proxy class for @see \Amasty\Shopby\Model\Category\Manager
 */
class Proxy extends \Amasty\Shopby\Model\Category\Manager implements \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Amasty\\Shopby\\Model\\Category\\Manager', $shared = true)
    {
     ...
     *
     * @return \Amasty\Shopby\Model\Category\Manager
     */
